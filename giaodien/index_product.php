...
<div class="container-fluid new-arrival">
		<p class="text-center title" style="font-family: system-ui; font-size:30px;">SẢN PHẨM MỚI</p>
		<hr class="hr-arrival">
		...
		?>
			...
			<div class="col-md-3 col-sm-12   text-center new-arrival-product" >		
				...
				<?php  echo $notificationhead; echo $notificationpercent; echo $notificationfoot; ?>
					...
					<div class="overlay">
					<a class="info" href="index.php?quanly=detail&id=<?php echo $row_new_product['MA_SP'] ?>&sale=<?php echo $idsale ?>">Chi tiết sản phẩm</a>
					</div>
...
//SELECT sp.MA_SP,sp.TEN_SP,SUM(cthd.SO_LUONG) as SOLUONG from chitiethoadon as cthd inner join sanpham as sp on cthd.MA_SP=sp.MA_SP WHERE cthd.MA_HD='4' ORDER BY SUM(cthd.SO_LUONG)
	...
	<div class="container-fluid  top-sold row">
		<p class="text-center title " style="font-family: system-ui;font-size:30px;">BÁN NHIỀU NHẤT</p>
		<hr class="hr-arrival" style="margin-top: 18px;">
		<br>
		...
		?>	
			<div class="col-md-4 col-sm-12 text-center top-sold-product">
				<div class="  top-sold-items">
					...
					<div class="overlay">
					<a class="info" href="index.php?quanly=detail&id=<?php echo $id_product_best_sell ?>&sale=<?php echo $idsale ?>">Chi tiết sản phẩm</a>
					</div>										
				</div>
		...
		<div class="col-md-1 col-sm-1"></div>
			<button type="button" class="btn-more ">
				<a href="index.php?quanly=product" style="color: #B0B0B0; text-decoration: none; text-align:center;" class="morefont">Xem thêm...</a> 
			</button>
		<br>
	    </div>
    </div>
